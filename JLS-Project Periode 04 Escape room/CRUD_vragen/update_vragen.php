...
if(isset($_POST['btn_wzg'])){
    if(UpdateVragen($_POST)) {
        $message = 'Vraag is succesvol bijgewerkt!';
        $messageType = 'success';
    } else {
        $message = 'Er ging iets mis bij het bijwerken van de vraag.';
        $messageType = 'error';
    }
}
...
<head>
    ...
    <title>Hospital Escape - Vraag Wijzigen</title>
    <style>
        body {
            margin: 0;
            height: 100vh;
        ...
        <div class="content-box">
            ...
            <?php if ($row): ?>
                <div class="question-info">
                    <h3>🔍 Vraag ID: <?php echo htmlspecialchars($row['id']); ?></h3>
                    <p>Wijzig de onderstaande gegevens en klik op "Bijwerken"</p>
                </div>
                ...
                <form method="post" action="">
                    ...
                    <div class="form-container">
                        <div class="form-group">
                            ...
                            <textarea name="question" id="question" required placeholder="Voer hier de vraag in..."><?php echo htmlspecialchars($row['question']); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="answer" id="answer" required placeholder="Het juiste antwoord" value="<?php echo htmlspecialchars($row['answer']); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="hint" id="hint" required placeholder="Een helpende hint voor de spelers..."><?php echo htmlspecialchars($row['hint']); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="roomId" id="roomId" required>
                                ...
                                <option value="1" <?php echo ($row['roomId'] == 1) ? 'selected' : ''; ?>>Kamer 1 - Horror Room</option>
                                <option value="2" <?php echo ($row['roomId'] == 2) ? 'selected' : ''; ?>>Kamer 2 - Tech Room</option>
                                <option value="3" <?php echo ($row['roomId'] == 3) ? 'selected' : ''; ?>>Kamer 3 - Final Room</option>
                            </select>
                    ...
                    <div class="buttons">
                        <button type="submit" name="btn_wzg" class="update-button">💾 Vraag Bijwerken</button>
